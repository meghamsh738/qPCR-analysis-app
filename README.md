...
Example run using the bundled `sample-data/qpcr_example.csv` (select **Example** in the sidebar) and default options (refreshed Dec 28, 2025; lab notebook neo-brutalist styling applied):
